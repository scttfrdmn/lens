...
func TestRunLaunch_InvalidEnvironment(t *testing.T) {
	...
	err := runLaunch("non-existent-env", "", "4h", "default", "", false)
...
func TestRunLaunch_ValidEnvironment(t *testing.T) {
	...
	err := runLaunch("data-science", "m7g.large", "8h", "default", "us-west-2", false)
...
func TestRunLaunch_InstanceTypeOverride(t *testing.T) {
	...
	err := runLaunch("minimal", "c7g.xlarge", "2h", "default", "", false)
