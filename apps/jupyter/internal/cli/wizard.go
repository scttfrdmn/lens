...
// NewWizardCmd creates the wizard command for lens-jupyter
func NewWizardCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "wizard",
		Short: "Interactive setup wizard for launching Jupyter Lab",
		Long: `The wizard command provides an interactive, beginner-friendly way to launch
your first Jupyter Lab instance. Instead of remembering flags and options,
...
func runWizard(cmd *cobra.Command, args []string) error {
	// Configure the wizard for Jupyter
	...
	fmt.Println()
	fmt.Println("🚀 Launching your Jupyter Lab instance...")
	fmt.Println()
