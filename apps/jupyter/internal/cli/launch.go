...
// waitForJupyterReady polls Jupyter Lab until it's ready to accept connections via SSM
func waitForJupyterReady(ctx context.Context, ssmClient *aws.SSMClient, instance *types.Instance) error {
	instanceID := *instance.InstanceId
